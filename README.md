...
- Верхняя строка не выделяется: у неё нет своего фона, разделительной линии и логотипа, текст
  выровнен по краям контента. Как в приложениях macOS, в заголовке окна нет имени приложения —
