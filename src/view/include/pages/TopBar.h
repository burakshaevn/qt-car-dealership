...
/*!
 * \brief Customer navigation: logo, text tabs, user and account actions.
 *
 * Deliberately chrome-less: no background of its own and no bottom rule, edges
 * aligned with the page content; the current section is marked by text colour only.
 *
